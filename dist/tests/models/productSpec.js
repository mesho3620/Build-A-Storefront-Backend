...
var testProduct = new product_1.products();
describe("Products Model", function () {
    ...
    it("create method should add a product", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testProduct.create({
                        name: "milk",
                        price: 250,
                        id: 1,
                    })];
    ...
    it("index method should return a list of products", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testProduct.index()];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([
                        {
    ...
    it("show method should return the correct product", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testProduct.show(1)];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual({
                        name: "milk",
    ...
    xit("delete method should remove the product", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    testProduct.delete(1);
                    return [4 /*yield*/, testProduct.index()];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([]);
                    return [2 /*return*/];
