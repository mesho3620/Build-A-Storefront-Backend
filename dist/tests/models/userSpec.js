...
describe("users Model", function () {
    ...
    it("create method should add a user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testuser.create({
    ...
    it("index method should return a list of users", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testuser.index()];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([
                        {
    ...
    it("show method should return the correct user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testuser.show(1)];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual({
                        first_name: "testuserFName",
    ...
    xit("delete method should remove the user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    testuser.delete(1);
                    return [4 /*yield*/, testuser.index()];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([]);
                    return [2 /*return*/];
