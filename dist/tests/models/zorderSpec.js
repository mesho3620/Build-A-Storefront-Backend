...
var testorder = new order_1.orders();
describe("orders Model", function () {
    ...
    it("create method should add a order", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testorder.create({
                        product_id: 1,
                        user_id: 1,
                        status: "active",
                        id: 2,
    ...
    it("index method should return a list of orders", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testorder.index()];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([
                        {
    ...
    it("show method should return the correct order", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testorder.show(2)];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual({
                        product_id: 1,
    ...
    xit("delete method should remove the order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    testorder.delete(2);
                    return [4 /*yield*/, testorder.index()];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([]);
                    return [2 /*return*/];
