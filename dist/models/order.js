        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO orders (product_ID, user_ID, Status) VALUES($1, $2, $3) RETURNING *";
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [o.product_id, o.user_id, o.status])];
                    case 2:
                        result = _a.sent();
                        order = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new order ".concat(o.id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
